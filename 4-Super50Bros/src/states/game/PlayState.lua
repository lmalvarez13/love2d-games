...
-- this function will search from start to end,
-- and move the "spawn point" (x value) of the 
-- player on level:enter()
function PlayState:find_ground()
    local res = 0
