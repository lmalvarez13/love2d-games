            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local levelupHPIncrease, levelupAttack, levelupDefense, levelupSpeed = self.playerPokemon:levelUp()

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
                        function()
                            
                            -- TODO : Show how stats increase for the assignment/

                            gStateStack:push( MenuState({
                                battleState = self.battleState,
                                items = {{text = "HP: "  .. tostring(levelupHPIncrease) .. " + " .. tostring(self.playerPokemon.HP - levelupHPIncrease) .. " = " .. tostring(self.playerPokemon.HP)},
                                         {text = "Atk: " .. tostring(levelupAttack) .. " + " .. tostring(self.playerPokemon.attack - levelupAttack) .. " = " .. tostring(self.playerPokemon.attack)},
                                         {text = "Def: " .. tostring(levelupDefense) .. " + " .. tostring(self.playerPokemon.defense - levelupDefense) .. " = " .. tostring(self.playerPokemon.defense)},
                                         {text = "Spd: " .. tostring(levelupSpeed) .. " + " .. tostring(self.playerPokemon.speed - levelupSpeed) .. " = " .. tostring(self.playerPokemon.speed)}}
