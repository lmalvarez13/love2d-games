...
function love.keypressed(key)
    ...
    if key == 'p' and gCurrentState == 'play' and isPaused == false then
    	isPaused = true
    	sounds['pause']:play()
    	sounds['music']:pause()
    	--love.audio.pause()
    elseif key == 'p' and gCurrentState == 'play' and isPaused == true then
    	isPaused = false
    	--love.audio.resume()
    	sounds['music']:resume()
    end
...
function love.draw()
    ...
    if isPaused then
    	...
    	love.graphics.draw(pauseImage, (VIRTUAL_WIDTH/2)-58, (VIRTUAL_HEIGHT/2)-58)
    end
